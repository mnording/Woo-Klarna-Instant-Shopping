...
class KlarnaShoppingButton {
    ...
    function __construct(){
        ...
        add_action("woocommerce_before_add_to_cart_form",array($this,'TestRender'));
    }
    ...
    function generateButtonKey(){
        $client = new GuzzleHttp\Client();
            $res = $client->request('POST', $this->baseUrl.'/instantshopping/v1/buttons',['verify' => false,'auth' => ['PK00178_96226a253d20', 'JlNBQLHZ57yFCe1E'], 'json' => [
                "merchant_urls" => [
    ...
    function InitiateButton(){
        ...
        $var = $WC_Shipping->calculate_shipping_for_package( $package, $package_key );
        var_dump($var);
